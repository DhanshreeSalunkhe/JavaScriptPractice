...
// create a card according to design and return the card container element
  ...
  image.setAttribute("src",productInfo.preview)
...
createList(accessories,'accessories_container')
createList(clothings,'clothing_container')
